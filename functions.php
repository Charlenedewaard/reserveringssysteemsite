<?php
 include_once 'includes/db.inc2.php';

// connect to database
$conn1 = mysqli_connect('localhost', 'root', '', 'multi_login');
...
function register(){
    ...
    // regristreerd nieuwe user als er geen error is
    if (count($errors) == 0) {
        $password = md5($password_1);// hashed
        ...
        if (isset($_POST['user_type'])) {
            ...
            $logged_in_user_id = mysqli_insert_id($conn1);
...
function e($val){
    global $conn1;
    return mysqli_real_escape_string($conn1, trim($val));
}
